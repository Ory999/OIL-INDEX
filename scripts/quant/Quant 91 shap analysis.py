# SHAP feature importance via gradient boosting on full combined feature set.
# Time-series CV for honest performance estimate, no look-ahead.
# Shows which components, NLP vs fundamentals, contribute most to WTI returns.
...
def run_shap_analysis():
    ...
    # Exclude raw prices and returns to prevent leakage.
