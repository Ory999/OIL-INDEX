# ADF stationarity tests on master_with_nlp.parquet.
# Non-stationary series are differenced and added back to master before Granger.
...
def run_stationarity_tests():
    # Use NLP master if available, fall back to quant only.
