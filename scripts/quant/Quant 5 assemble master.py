# Merge prices, EIA, FRED, COT onto business day index.
# Spine for all downstream scripts. Qual pipeline later writes master_with_nlp.parquet.
...
def assemble_master():
    ...
    # Derived features.
    # EIA surprise vs 4-week rolling mean.
    ...
    # Summary JSON for GitHub Actions logging.
    import json
    summary = {
