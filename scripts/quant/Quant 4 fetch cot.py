# Fetch CFTC Commitments of Traders for crude oil futures.
# Uses M_Money_Positions_Long_All and M_Money_Positions_Short_All from disaggregated report.
...
def fetch_cot_data():
    ...
    # Check cache and pick years to fetch.
    existing_years = set()
    existing       = None
    ...
    if out.exists():
        try:
            ...
            # Include latest_year then drop current_year, COT updates weekly.
