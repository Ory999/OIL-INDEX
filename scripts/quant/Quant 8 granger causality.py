# Granger causality tests on master_with_nlp.parquet, target oil_logret.
# Runs on full 2007 to present, includes OOS period 2020 to 2026.
# Results are DESCRIPTIVE, used for VAR feature selection and exploratory analysis.
# Do NOT use these p-values as live PRCSI weights, train-period rolling Granger required.
# Output carries scope=full_sample_descriptive for downstream readers.
    ...
    for feat in features:
        ...
        try:
            ...
            results.append({
                ...
                "n_obs":       len(pair),
                # Full-sample descriptive scope, not train-frozen.
