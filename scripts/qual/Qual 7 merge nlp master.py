# Merge NLP sentiment features into quantitative master dataset.
# Left join on trading date, all quantitative days preserved.
# Raw LLM signals filled 21 days for one publication cycle.
# Momentum and EMA features filled 5 days, stale momentum beyond a week not meaningful.
# Drops rows missing oil_logret before saving.
...
def merge_nlp_master():
    ...
    # Drop overlapping column names from NLP.
    ...
    # Raw LLM signals filled 21 days, one OPEC/EIA publication cycle.
    ...
    # Momentum and EMA features filled 5 days, stale momentum beyond a week is noise.
    ...
    # Warn on columns below 50% coverage.
